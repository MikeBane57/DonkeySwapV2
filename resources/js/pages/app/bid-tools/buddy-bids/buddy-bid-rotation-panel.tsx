        ...
        <div className="space-y-4 rounded-lg border border-sidebar-border/70 p-4">
            <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                    Map a 5-character pattern onto overlap days within each work
                    week. Training, vacation, pull, and non-overlap days are
                    skipped without consuming a pattern slot. A and B are
